defmodule JllyBot.Discord do
  ...
  def do_command(%{guild_id: guild_id, data: %{name: "tiktok-list"}}) do
    # TODO: implement
    "Tiktok list"
  end
  ...
  def handle_event({:INTERACTION_CREATE, interaction, _ws_state}) do
    ...
    Api.create_interaction_response(interaction, %{type: 4, data: %{content: content}})
  end
